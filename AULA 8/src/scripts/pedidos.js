...
function renderizarPedidos() {
  ...
  const spanResumo   = document.querySelector("#valor-total-resumo");v 
  ...
  if (pedidos.length === 0) {
    ...
    if (spanResumo)   spanResumo.textContent   = "R$ 0,00"; // Se não houver pedidos, contador volta a 0 itens
  ...
  pedidos.forEach(function (pedido, indice) {
    ...
    btnRemover.addEventListener("click", function () {
      ...
      lista.splice(indice, 1); //splice remove o item do array, a partir do índice, 1 item
